...
sensy_boi = minimalmodbus.Instrument('/dev/ttyACM0',mb_address) # Make an "instrument" object called sensy_boi (port name, slave address (in decimal))
...
data =sensy_boi.read_registers(0, 9, 4)
...
# Now Need to put values in to MQTT.....